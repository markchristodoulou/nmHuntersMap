...
python3 scripts/fetch_nm_hunt_data.py \
  --year 2024 \
  --index-url "https://www.wildlife.state.nm.us/home/hunting/" \
  --retries 6 \
...
The script now retries automatically; you can increase retries manually:

```bash
python3 scripts/fetch_nm_hunt_data.py --year 2024 --retries 8
```
